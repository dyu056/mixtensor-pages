"""FractionalMaxPool3d: NOT IMPLEMENTED as a numerical DSL adapter.
...
Inputs in smoke test: [[2, 3, 5, 5, 5]]
Outputs in smoke test: [{"shape": [2, 3, 2, 2, 2], "dtype": "torch.float64", "device": "cpu"}]
...
class FractionalMaxPool3d(nn.Module):
